...
![The target spec: a 512×512, 63-frame, black-background looping 2D sprite animation](/api/media/uploads/2026/07/1784776721899-target-ref.gif)
...
![The original character portrait, 1024×1024, front view](/api/media/uploads/2026/07/1784776669465-character-ref.png)
...
![Three routes side by side: video frame extraction, sequential image mode, grid template](/api/media/uploads/2026/07/1784776725254-three-routes.gif)
...
![Contact sheet from the video route — three rows, 18 frames](/api/media/uploads/2026/07/1784776679769-contact-video.png)
...
![The idle animation from the video route, 60 frames at 12fps](/api/media/uploads/2026/07/1784776729464-video-idle.gif)

Then I opened the run cycle…

![The run animation from the video route — the character turns his body and the scale drifts](/api/media/uploads/2026/07/1784776733721-video-run.gif)
...
![The model's output: a front + side turnaround on a green screen](/api/media/uploads/2026/07/1784776708846-side-turnaround.png)
...
![The grid template: the same base pose tiled into 8 cells at fixed height and fixed baseline](/api/media/uploads/2026/07/1784776692143-grid-template.png)
...
![What the model actually produced: a 6×2 layout of twelve, not the requested 4×2](/api/media/uploads/2026/07/1784776699438-raw-6x2.png)
...
![The finished four actions: idle / walk / run / attack](/api/media/uploads/2026/07/1784776689943-four-actions.gif)

Individually:

![Idle](/api/media/uploads/2026/07/1784776713198-sprite-idle.gif)
![Walk](/api/media/uploads/2026/07/1784776717596-sprite-walk.gif)
![Run](/api/media/uploads/2026/07/1784776715289-sprite-run.gif)
![Attack](/api/media/uploads/2026/07/1784776710881-sprite-attack.gif)

The full contact sheet — consistent in angle, scale, and baseline:

![32-frame contact sheet across all four actions](/api/media/uploads/2026/07/1784776675449-contact-final.png)
...
![Raw output from sequential mode — frames 5 and 6 are visibly larger](/api/media/uploads/2026/07/1784776702897-seq5-drift.png)
...
![Sequential mode after normalization — the skating is obvious](/api/media/uploads/2026/07/1784776705303-seq5-run.gif)
...
![5.0-pro nailed the 4×2 layout on the first try](/api/media/uploads/2026/07/1784776695851-raw-4x2-50pro.png)

Stacked side by side, the gap is clear:

![seedream 4.0 vs 5.0-pro run cycle](/api/media/uploads/2026/07/1784776672343-cmp-40-50pro.gif)
