---
title: "9 Sentences, 55M Tokens: Kimi Built Me an AI That Ages and Dies"
slug: ai-life-9-sentences
date: 2026-08-11
tags: [kimi, kimi-code, ai-companion, life-simulation, go, react]
status: draft
cover: assets/ai-life-9-sentences/cover.png
---

# 9 Sentences, 55M Tokens: Kimi Built Me an AI That Ages and Dies
...
![Home: create a person + people you know](assets/ai-life-9-sentences/shot-home.png)
...
![Chatting with Lina: text, selfie, and voice — tri-modal](assets/ai-life-9-sentences/shot-chat-lina.png)

Text by DeepSeek, selfie by gpt-image, and that 18-second audio clip is MiniMax voice. Look closer at the selfie:

![Lina's selfie](assets/ai-life-9-sentences/lina-selfie.png)
...
![Lina's detail page](assets/ai-life-9-sentences/shot-person.png)
...
![Chen Yuan: business picked up — tiring, but fulfilling](assets/ai-life-9-sentences/shot-chat-chenyuan.png)

Su Wanqing, 22, from Nanjing, opens with "the hospital's been packed, my shifts are fully booked"...

![Su Wanqing: fully booked shifts](assets/ai-life-9-sentences/shot-chat-suwanqing.png)
...
![World page](assets/ai-life-9-sentences/shot-world.png)
...
![Admin / debug page](assets/ai-life-9-sentences/shot-admin.png)
...
![Family page: three Linas](assets/ai-life-9-sentences/shot-family.png)
