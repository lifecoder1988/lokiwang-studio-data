# 16 Sentences, 4½ Hours: Codex Built Me a 3D Character Creator — the Hard Part Was the Clothes
...
![The MPFB base mesh, generated in Blender](assets/mpfb-godot-character-creator/still-blender-preview.png)
...
![The first character-creator prototype in Godot](assets/mpfb-godot-character-creator/still-gender.jpg)
...
![The gender slider morphing continuously](assets/mpfb-godot-character-creator/gif-gender.gif)

Female to male is continuous. You can stop on any frame in between.

![Muscle and build](assets/mpfb-godot-character-creator/still-muscle.jpg)

![Height proportions](assets/mpfb-godot-character-creator/still-height.jpg)
...
![Real hair asset: the bob](assets/mpfb-godot-character-creator/still-hair.jpg)

![Real MakeHuman system assets: short hair + work suit](assets/mpfb-godot-character-creator/still-worksuit.jpg)
...
![360° orbit view](assets/mpfb-godot-character-creator/gif-orbit.gif)
...
![Clothing following the chest morph](assets/mpfb-godot-character-creator/gif-breast-cloth.gif)
...
![Skin lightness](assets/mpfb-godot-character-creator/still-skin-light.jpg)

![Skin warmth](assets/mpfb-godot-character-creator/still-skin-warm.jpg)

![Eye size](assets/mpfb-godot-character-creator/still-eyes.jpg)

![Chin width](assets/mpfb-godot-character-creator/still-chin.jpg)

## 09 Wardrobe: 14 meshes deforming together

Hair, beard, outfit, shoes, tattoos — every slot swaps or hides at runtime.

![Hair, beard, outfit and shoes switching in sequence](assets/mpfb-godot-character-creator/gif-outfit.gif)
...
![Beard: full beard](assets/mpfb-godot-character-creator/still-beard.jpg)

![Shoes: sneakers / boots](assets/mpfb-godot-character-creator/still-shoes.jpg)

![Procedurally generated, fully morphable tattoos](assets/mpfb-godot-character-creator/still-tattoo.jpg)
...
![360° back view](assets/mpfb-godot-character-creator/still-orbit-back.jpg)
...
![Create your own 3D game character](assets/mpfb-godot-character-creator/still-ending.jpg)
