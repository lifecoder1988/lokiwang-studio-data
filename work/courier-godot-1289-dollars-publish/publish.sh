...
# 海报帧(视频 poster)
up "$ASSETS/gameplay-poster.jpg" IMG_poster
# 正文图片
up "$ASSETS/hud.jpg"             IMG_hud
up "$ASSETS/story.jpg"           IMG_story
up "$ASSETS/dispatch.jpg"        IMG_dispatch
up "$ASSETS/gif-redlight.gif"    IMG_gif-redlight
up "$ASSETS/redlight-fine.jpg"   IMG_redlight-fine
up "$ASSETS/night-ride.jpg"      IMG_night-ride
up "$ASSETS/gif-onfoot.gif"      IMG_gif-onfoot
up "$ASSETS/elevator.jpg"        IMG_elevator
up "$ASSETS/delivery.jpg"        IMG_delivery
up "$ASSETS/summary.jpg"         IMG_summary
up "$ASSETS/effect-wall.jpg"     IMG_effect-wall
# 视频
up "$ASSETS/gameplay-highlight.mp4" VID_gameplay-highlight
...
POSTERS = {'gameplay-highlight': 'IMG_poster', 'gameplay-full': 'IMG_poster'}
def vrepl(m):
    name = m.group(1)
