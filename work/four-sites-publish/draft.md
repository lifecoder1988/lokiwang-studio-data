...
<video src="{{V:air-assembly}}"></video>
...
<video src="{{V:oled-explode}}"></video>

爆炸图是朝观众展开的——OLED 面板这种「千层饼」结构，平铺开来那一下还挺震撼。

真正值回票价的是**观影模式**：

<video src="{{V:oled-watch}}"></video>
