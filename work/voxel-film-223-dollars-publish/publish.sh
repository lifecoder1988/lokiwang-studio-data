...
# 视频 poster 帧
up "$ASSETS/film-dwarfs-poster.jpg" IMG_film-dwarfs-poster
up "$ASSETS/film-hero-poster.jpg"   IMG_film-hero-poster
# 正文图片
up "$ASSETS/still-heavy.png"        IMG_still-heavy
up "$ASSETS/still-witch.png"        IMG_still-witch
up "$ASSETS/still-arrive.png"       IMG_still-arrive
up "$ASSETS/still-sneeze.png"       IMG_still-sneeze
up "$ASSETS/gif-sneeze.gif"         IMG_gif-sneeze
up "$ASSETS/gif-plank.gif"          IMG_gif-plank
up "$ASSETS/still-title.png"        IMG_still-title
# 视频
up "$ASSETS/film-dwarfs.mp4"        VID_film-dwarfs
up "$ASSETS/film-hero.mp4"          VID_film-hero
...
POSTERS = {'film-dwarfs': 'IMG_film-dwarfs-poster', 'film-hero': 'IMG_film-hero-poster'}
def vrepl(m):
    name = m.group(1)
