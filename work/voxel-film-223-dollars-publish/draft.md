# 14 Sentences, $223: Claude Shot Two Voxel Films in a Day
...
<video src="{{V:film-hero}}"></video>

![A'ying: "You're too heavy." The planks drop; the brute goes down](assets/voxel-film-223-dollars/still-heavy.png)
...
![Xiaomei tied to the great tree. Wupo: "No one can save you."](assets/voxel-film-223-dollars/still-witch.png)

![Seven dwarfs file across the plank — one hood color each, readable even in wide shots](assets/voxel-film-223-dollars/still-arrive.png)
...
![Sneezy charging up; everyone braces](assets/voxel-film-223-dollars/still-sneeze.png)
...
![A—CHOO!! The spellbook takes flight](assets/voxel-film-223-dollars/gif-sneeze.gif)
...
![The princess crosses the plank: "Thank you all."](assets/voxel-film-223-dollars/gif-plank.gif)
...
![Stubborn: "We're light enough."](assets/voxel-film-223-dollars/still-title.png)
