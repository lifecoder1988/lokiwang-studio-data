...
status: published
cover: /api/media/uploads/2026/08/1785844713490-cover.png
published_url: https://lokiwang.com/journal/kimi-llm-price-calculator
post_id: 208
---
...
![最终页面：价格、跑分、套餐和月成本都塞进了一张长页](/api/media/uploads/2026/08/1785844716092-01-cover-desktop.png)
...
![15:37 出现的核心功能：分数区间、token 用量和最低成本排序](/api/media/uploads/2026/08/1785844718534-02-calculator.png)
...
![同一个模型，官方 API、聚合渠道和会员套餐放在一张表里](/api/media/uploads/2026/08/1785844720903-03-price-overview.png)
...
![月输入和输出一改，所有模型按最低月成本重新排队](/api/media/uploads/2026/08/1785844739145-09-cost-calculator.gif)

输入 50M、输出 10M 是一张榜；输入 500M、输出 100M，又是另一张账单。

![把用量放大十倍后，账单也终于露出了成年人的样子](/api/media/uploads/2026/08/1785844729426-06-calculator-heavy-usage.png)
...
![把 LMArena 下限往右推，候选模型一层层变少](/api/media/uploads/2026/08/1785844742588-10-score-filter.gif)
...
![除了 LMArena，它还保留了各模型其他公开基准和来源](/api/media/uploads/2026/08/1785844726182-05-benchmarks.png)
...
![套餐价格不只列数字，连年付折月和数据置信度也写进备注](/api/media/uploads/2026/08/1785844723557-04-subscriptions.png)
...
![手机端：四个输入框叠起来，表格继续保持可读](/api/media/uploads/2026/08/1785844735800-08-mobile.png)

![暗色模式：很像一个深夜还在帮老板算 token 成本的后台](/api/media/uploads/2026/08/1785844733356-07-dark-mode.png)
