...
platform: weixin
source: plane-war-qwen
cover: assets/plane-war-qwen/title.png
---
...
> 🕹️ 在线试玩（键盘操作，手机也能玩）：https://plane-war-3fu.pages.dev
...
九类素材，一次全出：玩家机、三种敌机（侦察机/炮手/重装）、Boss、两种子弹、爆炸、强化星星。画风统一靠一份 `_style.md`：saturated neon palette (cyan, magenta, amber) on a deep space blue-black，1990s 纵版射击游戏美学。
