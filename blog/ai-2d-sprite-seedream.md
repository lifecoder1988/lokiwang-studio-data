...
status: published
published_url: https://lokiwang.com/journal/ai-2d-sprite-seedream
post_id: 181
cover: /api/media/uploads/2026/07/1784776686828-cover.png
---
...
![目标规格：512×512、63 帧、黑底循环的 2D 动作素材](/api/media/uploads/2026/07/1784776721899-target-ref.gif)

于是我扔给 Claude 一句话：**参考 demo，密钥在 .env，帮我生成类似 target 的游戏素材，角色参考这张图。**

这是我的角色，一张正面立绘，深蓝马甲 + 绿松石领结（记住这个领结，后面它是个雷）：

![原始角色立绘，1024×1024 正面全身](/api/media/uploads/2026/07/1784776669465-character-ref.png)
...
![三条路线并排对比：视频抽帧、组图模式、网格模板](/api/media/uploads/2026/07/1784776725254-three-routes.gif)
...
![视频路线出的四个动作接触表，三行 18 帧](/api/media/uploads/2026/07/1784776679769-contact-video.png)

单看画质是真不错。待机这条甚至挺灵动，呼吸起伏、头发衣角轻摆、旁边那颗小星星还会一闪一闪：

![视频路线的待机动画，60 帧 12fps](/api/media/uploads/2026/07/1784776729464-video-idle.gif)

然后我打开跑步这条……

![视频路线的跑步动画，角色在自己转身、缩放也在漂](/api/media/uploads/2026/07/1784776733721-video-run.gif)
...
![模型输出的正面+侧面转身图，绿幕底](/api/media/uploads/2026/07/1784776708846-side-turnaround.png)
...
![格子模板：同一张基准像按固定身高、固定基线铺进 8 格](/api/media/uploads/2026/07/1784776692143-grid-template.png)
...
![模型实际排成 6×2 十二格，而不是要求的 4×2](/api/media/uploads/2026/07/1784776699438-raw-6x2.png)
...
![四个动作成品：idle / walk / run / attack](/api/media/uploads/2026/07/1784776689943-four-actions.gif)

拆开看：

![待机](/api/media/uploads/2026/07/1784776713198-sprite-idle.gif)
![走路](/api/media/uploads/2026/07/1784776717596-sprite-walk.gif)
![跑步](/api/media/uploads/2026/07/1784776715289-sprite-run.gif)
![攻击](/api/media/uploads/2026/07/1784776710881-sprite-attack.gif)

整套的接触表长这样，视角、缩放、基线三统一：

![四个动作 32 帧接触表](/api/media/uploads/2026/07/1784776675449-contact-final.png)
...
![组图模式的原始输出，第 5、6 帧明显大了一圈](/api/media/uploads/2026/07/1784776702897-seq5-drift.png)
...
![组图模式归一化后的跑步，滑步感明显](/api/media/uploads/2026/07/1784776705303-seq5-run.gif)
...
![5.0-pro 一次到位排成 4×2](/api/media/uploads/2026/07/1784776695851-raw-4x2-50pro.png)

上下并排一看，差距挺明显：

![seedream 4.0 vs 5.0-pro 跑步循环对比](/api/media/uploads/2026/07/1784776672343-cmp-40-50pro.gif)
