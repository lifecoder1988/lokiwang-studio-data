...
slug: kimi-three-sites
date: 2026-07-30
tags: [kimi, kimi-k3, websites, vibe-coding, trpc, hono, full-stack]
status: published
published_url: https://lokiwang.com/journal/kimi-three-sites
post_id: 199
cover: /api/media/uploads/2026/07/1785412616959-cover.png
---
...
![三个站：水果机 / A股每日复盘 / 网页版微信](/api/media/uploads/2026/07/1785412616959-cover.png)
...
![幸运水果机的机台界面，游客模式送 1000 积分](/api/media/uploads/2026/07/1785412622368-banana-idle.jpg)
...
![八种水果各下 50 分，本局下注 400](/api/media/uploads/2026/07/1785412629007-banana-bets.jpg)

## 03 转盘停在哪，是服务器说了算

我在旁边看它写代码时发现一个挺专业的细节：**停格结果是服务端随机出的**，前端拿到答案后只负责「配合演出」——加速、绕圈、减速，最后精准停在那一格。

![下注 → 转动 → 停格 → 结算](/api/media/uploads/2026/07/1785412633082-gif-spin.gif)

为啥要绕这一圈？因为结果如果在浏览器里生成，按个 F12 就能改，排行榜当场作废……这个防作弊的思路我自己都没想到。

## 04 中奖那一下，是有彩带雨的

![中得苹果 ×3，+150](/api/media/uploads/2026/07/1785412636113-banana-win-150.jpg)

![中得柠檬 ×5，+250，彩带落了满屏](/api/media/uploads/2026/07/1785412638633-banana-win-250.jpg)
...
![前三名做成领奖台，冠军头像最大](/api/media/uploads/2026/07/1785412640998-banana-leaderboard.jpg)
...
![手机上的下注面板，8 列变 4 列](/api/media/uploads/2026/07/1785412645023-banana-mobile.jpg)

![手机上转动中](/api/media/uploads/2026/07/1785412647621-banana-mobile-spin.jpg)
...
![六大指数 + 近 30 日迷你走势，红涨绿跌](/api/media/uploads/2026/07/1785412652151-duwang-cards.jpg)

## 08 「情绪观察」这四块，是算出来的

量能环比、风格分化（科创50 与沪指的剪刀差）、创业板 vs 沪指、近 20 日环境——不是预置文案，是当日数据推出来的。

![情绪观察：量能 +15.35%、风格分化 -5.78pct](/api/media/uploads/2026/07/1785412654916-duwang-sentiment.jpg)

![主走势图可以切六个指数](/api/media/uploads/2026/07/1785412657542-duwang-chart-kc50.jpg)

## 09 82 个交易日，随便回看哪天

按一下「前一交易日」，整页所有模块——指数卡片、情绪观察、区间表现——全部按那一天的真实数据重算，走势图上还有一条竖线标你在看哪天。

![一路往回按，整页数据跟着变](/api/media/uploads/2026/07/1785412664661-gif-days.gif)

![回看 2026-04-07：标题变「历史回看」，多出一个「回到最新」](/api/media/uploads/2026/07/1785412667460-duwang-history.jpg)
...
![复盘笔记 + 股友留言，边界写得很清楚](/api/media/uploads/2026/07/1785412670104-duwang-notes.jpg)

![手机上的复盘站](/api/media/uploads/2026/07/1785412672257-duwang-mobile.jpg)
...
![登录页：Kimi 一键登录 / 账号密码二选一](/api/media/uploads/2026/07/1785412677330-chatme-login.jpg)

我注册了俩号（小明、大宝）实测——头像不用上传，用户名哈希出一个固定底色，首字母当头像。

![搜人、发起单聊](/api/media/uploads/2026/07/1785412679738-chatme-userlist.jpg)

## 12 消息 2 秒一刷，图片自动压到 900px

没上 WebSocket，就是老实轮询，2 秒一次，体感接近实时。

![你一句我一句，接近实时](/api/media/uploads/2026/07/1785412682984-gif-chat.gif)

我顺手把上面那张水果机中奖图发了过去——图片压到 900px 直接 base64 存字段，省掉一整套对象存储。

![单聊里发图、发表情，Enter 发送](/api/media/uploads/2026/07/1785412685496-chatme-chat.jpg)

## 13 未读红点，没有「未读表」

它的做法是：每个成员记一个 `lastReadAt`，**未读数 = 比我最后已读时间晚的消息数**。红点是算出来的，不是存出来的。

![红点、群成员数、时间戳](/api/media/uploads/2026/07/1785412687312-chatme-unread.jpg)

![建群：起名、勾人，群里能看成员列表](/api/media/uploads/2026/07/1785412689339-chatme-group.jpg)

![手机上的群聊](/api/media/uploads/2026/07/1785412691222-chatme-mobile.jpg)

## 14 然后，我一个字把它搜白屏了

在「发起单聊」里我手贱打了一个 `d`……

![页面白了，只剩右下角那个 Kimi Agent 徽章还在](/api/media/uploads/2026/07/1785412693083-chatme-whitescreen.jpg)
