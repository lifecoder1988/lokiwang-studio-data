...
platform: weixin
source: xiaochoupai-godot-470-dollars
...
> 📺 完整对局视频（选牌 → 连相生 → 两仪阵结成 → 一道金光糊到水妖脸上）在博客原文：`lokiwang.com/journal/xiaochoupai-godot-470-dollars`
...
- 引擎：Godot 4.7 + GDScript，四层架构，H1–H8 硬约束机器校验，417 测试全绿
- 完整对局视频在博客原文：`lokiwang.com/journal/xiaochoupai-godot-470-dollars`
